...
$(document).ready(function () {
  ...
  function ValidMail(email, form) {
    ...
    if (form.classList.contains("main__form")) {
      !valid ? email.style.outline = "1px solid red" : email.style.outline = "1px solid #000";
    } else if (form.classList.contains("modal-form")) {
      !valid ? email.style.borderBottom = "1px solid red" : email.style.borderBottom = "1px solid #000";
    }
  ...
  function ValidPhone(phone, form) {
    ...
    if (form.classList.contains("main__form")) {
      !valid ? phone.style.outline = "1px solid red" : phone.style.outline = "1px solid #000";
    } else if (form.classList.contains("modal-form")) {
      !valid ? phone.style.borderBottom = "1px solid red" : phone.style.borderBottom = "1px solid #000";
    }
